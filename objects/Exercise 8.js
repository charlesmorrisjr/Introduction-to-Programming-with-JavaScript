...
// you want to copy. Do not mutate the original object. The function should let
// you omit the array of keys argument when calling the function. If you do omit
// the argument, the function should copy all of the existing keys from the
// object.
